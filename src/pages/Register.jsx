  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute bottom-1/3 right-1/5 w-3 h-3 bg-indigo-400 rounded-full opacity-30"></div>
        <div className="absolute top-1/2 right-1/4 w-2 h-2 bg-purple-500 rounded-full opacity-40"></div>
        <div className="absolute bottom-1/4 left-1/3 w-4 h-4 bg-indigo-300 rounded-full opacity-30"></div>
      </div>
